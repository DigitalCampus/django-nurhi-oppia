...
class Migration(migrations.Migration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.current_working_city'
        db.delete_column(u'oppia_profile', 'current_working_city')

        # Deleting field 'Profile.current_place_employment'
        db.delete_column(u'oppia_profile', 'current_place_employment')

        # Deleting field 'Profile.currently_working_facility'
        db.delete_column(u'oppia_profile', 'currently_working_facility')

        # Adding field 'Profile.fp_methods_provided'
        db.add_column(u'oppia_profile', 'fp_methods_provided',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.current_working_city'
        db.add_column(u'oppia_profile', 'current_working_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Profile.current_place_employment'
        db.add_column(u'oppia_profile', 'current_place_employment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Profile.currently_working_facility'
        db.add_column(u'oppia_profile', 'currently_working_facility',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Deleting field 'Profile.fp_methods_provided'
        db.delete_column(u'oppia_profile', 'fp_methods_provided')
