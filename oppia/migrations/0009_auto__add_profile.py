...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'oppia_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('phoneno', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('current_working_city', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('currently_working_facility', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('staff_type', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('nurhi_sponsor_training', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('current_place_employment', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('highest_education_level', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
        ...
        db.send_create_signal(u'oppia', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'Profile'
        db.delete_table(u'oppia_profile')
    ...
    models = {
        ...
        u'oppia.profile': {
            ...
            'current_place_employment': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'current_working_city': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
